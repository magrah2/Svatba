<?php
/**
 * Blossom Wedding Customizer Slider Control.
 * 
...
if ( ! class_exists( 'Blossom_Wedding_Slider_Control' ) ){
	/**
	 * Slider control (range).
    */
	class Blossom_Wedding_Slider_Control extends WP_Customize_Control {

		public $type = 'blossom-wedding-slider';
        ...
        public function enqueue() {            
            wp_enqueue_style( 'blossom-wedding-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'blossom-wedding-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
