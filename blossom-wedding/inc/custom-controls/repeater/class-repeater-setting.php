<?php
/**
 * Blossom Wedding Repeater Customizer Setting.
 * 
...
if ( ! class_exists( 'Blossom_Wedding_Repeater_Setting' ) ) {

	/**
	 * Repeater Settings.
	 */
	class Blossom_Wedding_Repeater_Setting extends WP_Customize_Setting {
